...
const BASE_URL =
  "https://my-json-server.typicode.com/themeland/json-server/themeOnePricingSection";
        ...
        <div className="container">
                    ...
                    <div key={`p_${idx}`} className="col-12 col-md-6 mt-4">
                      ...
                      <div className="single-price-plan text-center p-5">
                        ...
                        <div className="plan-button">
                          <a href="/contact-page" className="btn mt-4">
                            {item.planBtn}
                          </a>
                        </div>
                      </div>
          ...
          <div className="row justify-content-center pt-5">
            <p className="text-body pt-4 fw-5">
              {this.state.data.text} <a href="/#">{this.state.data.textLink}</a>
            </p>
          </div>
        </div>
      </section>
