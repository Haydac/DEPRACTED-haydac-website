...
const dataObj = Data.themeOneFooterSection;
...
class FooterSection extends Component {
  ...
  componentDidMount() {
    ...
    this.setState({
      data: dataObj,
      iconList: dataObj.iconList,
      footerList_1: dataObj.footerList_1,
      footerList_2: dataObj.footerList_2,
      footerList_3: dataObj.footerList_3,
    });
  }
  render() {
    return (
