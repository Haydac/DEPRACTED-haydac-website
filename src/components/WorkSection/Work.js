...
// console.log("ANJOLAS DATA HERE: ", Data.themeOneWorkSection);

const dataObj = Data.themeOneWorkSection;
const BASE_URL =
...
class Work extends Component {
  ...
  componentDidMount() {
    ...
    //     });
    //     console.log("WORK DATA ", this.state.workData);
    //   })
    //   .catch((err) => console.log(err));
    this.setState({
      data: dataObj,
      workData: dataObj.workData,
    });
  }
  render() {
    return (
